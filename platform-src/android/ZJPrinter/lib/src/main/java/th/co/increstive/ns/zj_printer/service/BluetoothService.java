...
package th.co.increstive.ns.zj_printer.service;
...
public class BluetoothService {
     ...
     */
    public BluetoothService(Context context, EventHandler handler) {
        mAdapter = BluetoothAdapter.getDefaultAdapter();
        mState = STATE_NONE;
        mHandler = handler;

        mHandler.handleEvent(MESSAGE_STATE_CHANGE, STATE_NONE, "");
    }
...
//        mHandler.obtainMessage(MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
        mHandler.handleEvent(MESSAGE_STATE_CHANGE, state, "");
    }
...
//        mHandler.sendMessage(msg);
        mHandler.handleEvent(MESSAGE_DEVICE_NAME, MESSAGE_DEVICE_NAME, device.getName());
...
//        msg.setData(bundle);
//        mHandler.sendMessage(msg);
        mHandler.handleEvent(MESSAGE_TOAST, 0, "Unable to connect device");
...
//        msg.setData(bundle);
//        mHandler.sendMessage(msg);
        mHandler.handleEvent(MESSAGE_TOAST, 0, "Device connection was lost");
    }
...
//                                .sendToTarget();
                        mHandler.handleEvent(MESSAGE_READ, bytes, "");
                    } else {
...
//                        .sendToTarget();
                mHandler.handleEvent(MESSAGE_WRITE, 0, buffer.toString());
            } catch (IOException e) {
