...
export class EscPosEncoder {
    ...
    /**
       ...
       *
      */
    private _queue(value: Array<any>) {
    ...
    /**
      ...
      */
    private _wrap(value: string, position: number): Array<any> {
    ...
    /**
       ...
       *
       */
    text(value: string, wrap: number = 0): EscPosEncoder {
    ...
    /**
       ...
       *
       */
    line(value: string, wrap: number = 0): EscPosEncoder {
    ...
    /**
       ...
       *
       */
    size(size: 0 | 1 | 2 | 3 | 4 | 5 | 6 | 7): EscPosEncoder {
        const intToWidth = [0x00, 0x10, 0x20, 0x30, 0x40, 0x50, 0x60, 0x70];
        const intToHeight = [0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07];
        const value = intToWidth[size] + intToHeight[size];
    ...
    /**
       ...
       *
       */
    rule(options: any): EscPosEncoder {
    ...
    /**
       ...
       *
       */
    box(options: any, contents: string | Function): EscPosEncoder {
        options = Object.assign({
            style: 'single',
   ...
   */
    ...
    /**
       ...
       *
       */
    raw(data: Array<any>): EscPosEncoder {
        this._queue(data);
